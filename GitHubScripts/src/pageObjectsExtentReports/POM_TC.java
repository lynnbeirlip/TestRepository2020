...
public class POM_TC {
	...
	public static void main(String[] args) throws InterruptedException {
			...
			//htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "workspace/test-output/STMExtentReport.html");
		...
		LogIn_Page.txtbx_UserName(driver).sendKeys("mngr193906");
		LogIn_Page.txtbx_Password(driver).sendKeys("jAtYnAd");
